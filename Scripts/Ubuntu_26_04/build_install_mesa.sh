...
apt-get update
apt install -y libgl1-mesa-dri libgl1-mesa-dri:i386
...
apt-mark hold \
  ...
  libgl1-mesa-dri:i386 libglx-mesa0 libglx-mesa0:i386 libllvm21 libllvm21:i386 \
  ...
  mesa-vulkan-drivers:i386 libgl1 libgl1:i386
