...
git clone --depth=1 --branch vulkan-sdk-1.4.357.0 --recurse-submodules https://github.com/LunarG/gfxreconstruct.git
...
# GCC 15 warns about a call to std::fill in
# framework/encode/vulkan_state_tracker_initializers.h so pass
# -Wno-error=stringop-overflow to ignore it.
cmake \
